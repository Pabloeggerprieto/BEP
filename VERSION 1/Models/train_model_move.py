...
def build_model(input_shape, num_classes):
    """Build and compile the CNN model for predicting chess moves."""
    model = Sequential([
...
def train_model():
    ...
    model_path = os.path.join('models', 'model_move.h5')
    encoder_path = os.path.join('label_encoders', 'move_label_encoder.pkl')
